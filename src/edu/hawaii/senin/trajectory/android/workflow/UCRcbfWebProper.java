...
public class UCRcbfWebProper extends UCRGenericClassifier {
  ...
  // data locations
  //
  private static final String TRAINING_DATA = "results/release_10_added_lines_28.csv";
  private static final String TEST_DATA = "results/release_10_all_added_lines_28.csv";

  // SAX parameters to iterate over
  //
  private static final int[][] params = {
    { 18, 4, 12, NOREDUCTION }, { 18, 4, 12, EXACT }, { 18, 4, 12, CLASSIC },
    { 7, 5, 15, NOREDUCTION }, { 7, 5, 15, EXACT }, { 7, 5, 15, CLASSIC } };
