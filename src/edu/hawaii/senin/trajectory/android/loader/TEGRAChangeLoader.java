 ...
 * 
 */
public class TEGRAChangeLoader {

  private static final String[] branches = { "remotes/origin/android-tegra-moto-2.6.36",
  ...
  private static final String REPOSITORY_ROOT = "/home/psenin/thesis/android/tegra/.git";
  ...
  static {
    consoleLogger = (Logger) LoggerFactory.getLogger(TEGRAChangeLoader.class);
  ...
  public static void main(String[] args) throws IOException, RefAlreadyExistsException,
    ...
    for (String branch : branches) {
      ...
      ChangeProject project = db.getProject("TEGRA");
